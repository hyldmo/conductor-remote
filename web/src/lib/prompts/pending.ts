 ...
 *
 * The composer clears its draft as soon as a send *starts* (web/src/components/session/Composer.tsx), because
 ...
 * once the entry outlives the relay's 10-minute send memo (src/delivery/sendonce.ts): inside
