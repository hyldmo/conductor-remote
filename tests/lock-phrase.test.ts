 ...
 * (writes.ts ▸ lockBlocked) and the phone draws its unlock link beside it — while the
 ...
 */
const script = readFileSync(path.join(import.meta.dirname, '../src/conductor.applescript'), 'utf8')
