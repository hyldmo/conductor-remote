/**
 * The speech caps (`src/voice/speech.ts`).
 *
 * Worth pinning because both failure directions are silent. A clip that overruns its cap
 * by the ellipsis is invisible against `src/notifications/notify.ts`'s byte budget, which carries eight
...
import { clipExact, oneLine, speechText } from '../../src/voice/speech.ts'
